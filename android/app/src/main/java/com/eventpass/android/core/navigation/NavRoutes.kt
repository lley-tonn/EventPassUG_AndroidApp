...
sealed class NavRoutes(val route: String) {
    ...
    object ChangeEmail : NavRoutes("change_email")
    object AddPhone : NavRoutes("add_phone")
    object EmailVerification : NavRoutes("email_verification")
    object VerifyPhone : NavRoutes("verify_phone")
